...
foreach ($comm->executesql($sql) as $row)
{
    ...
    {
        $html .='<tr><td rowspan="2"> MEN INDIVIDUAL</td><td style="width:20px;"> '.$i.'</td><td style="width:150px;"> '. strtoupper($row['name']) . '</td><td style="width:100px;"> '. strtoupper($row['lastname']) . '</td><td> '. $row['aadhaar'] . '</td><td> '.date("d/m/Y", strtotime($row['dob'])). '</td></tr>';
        $i=2;
    }
...
foreach ($comm->executesql($sql) as $row)
{
    ...
    {
        $html .='<tr><td rowspan="2"> WOMEN INDIVIDUAL</td><td> '.$i.'</td><td style="width:150px;"> '. strtoupper($row['name']) . '</td><td style="width:100px;"> '. strtoupper($row['lastname']) . '</td><td> '. $row['aadhaar'] . '</td><td> '. date("d/m/Y", strtotime($row['dob'])) . '</td></tr>';
        $i=2;
    }
...
foreach ($comm->executesql($sql) as $row)
{
    ...
    {
        $html .='<tr><td rowspan="2"> MIXED PAIR</td><td> '.$i.'</td><td style="width:150px;"> '. strtoupper($row['name']) . '</td><td style="width:100px;"> '. strtoupper($row['lastname']) . '</td><td> '. $row['aadhaar'] . '</td><td> '. date("d/m/Y", strtotime($row['dob'])) . '</td></tr>';
        $i=2;
    }
...
foreach ($comm->executesql($sql) as $row)
{
    if($row['trios'] && $i==1)
    {
        $html .='<tr><td rowspan="3">TRIOS</td><td> '.$i.'</td><td style="width:150px;"> '. strtoupper($row['name']) . '</td><td style="width:100px;"> '. strtoupper($row['lastname']) . '</td><td> '. $row['aadhaar'] . '</td><td> '. date("d/m/Y", strtotime($row['dob'])) . '</td></tr>';
        $i++;
    }
    else if($row['trios'])
    {
...
$html .='<tr><td>COACH</td><td> 1</td><td style="width:150px;"> UJJAL</td><td style="width:100px;"> MONDAL</td><td></td><td></td></tr>';
$html .='<tr><td>MANAGER</td><td> 1</td><td style="width:150px;"> </td><td style="width:100px;"> </td><td></td><td></td></tr>';
$html .='</table>';
