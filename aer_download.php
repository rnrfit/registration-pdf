          ...
          <form class="form-horizontal" id="commentForm" action="aer_entryform.php" method="post" enctype="multipart/form-data">  
           <div class="card-header">
            ...
            <div class="form-group row">
              <div class="col-lg-3">
                <a href="aer_firstform.php?id=<?php echo $id; ?>" class="btn" target="_blank">ENTRY FORM</a> &nbsp; 
              </div>
              <div class="col-lg-3">
                 <a href="aer_certificate.php?id=<?php echo $id; ?>" target="_blank" class="btn">AGE CERTIFICATE</a>
              </div>
               <div class="col-lg-3">
                 <a href="aer_biodata.php?id=<?php echo $id; ?>" target="_blank" class="btn">BIO DATA</a>
              </div>
            </div>       
            <div class="card-header">
              <hr>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-6">
                 <select class="form-control" id="eventgroup" name="eventgroup">
            ...
            <div class="form-group row">
              <div class="col-lg-5">
                <input type="submit" value="Download Entry Form" name="submit"></input>
              </div>
               <div class="col-lg-5">&nbsp;
               </div>
            </div>
