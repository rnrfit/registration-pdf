  ...
  if (empty($_POST['name'])) {
    ...
    if (!empty($_POST)) {
      ...
      if (empty($checkifexists)) {
        //print_r('expression')       ;
        $reg_id = $participant->participantadd_aer($fname,addslashes($name),addslashes($lastname),addslashes($fathername),$district,$club,$eventgroup,$eventcategory,$dob,$aadhaar,$Gender,$policyno,addslashes($policycompany),$role,$height,$weight,$bloodgroup,$costumesize,$tshirtsize,$tracksuit,$shoessize,addslashes($address),$email,$phone,$school,$grade,addslashes($Bankname),addslashes($Branch),$accountno,$ifsccode,addslashes($parent),$parentphone,$Event,$txnid,$photo,$idproof,$city,$state,$artistic,$rhythmic,$aerobic,$acrobatic);
          ...
          <form class="form-horizontal" id="commentForm" action="bga_register.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-6">
                ...
                <input type="text" name="lastname" class="form-control" id="lastname" minlength="1" maxlength="40" onkeypress="return (event.charCode === 32)|| (event.charCode === 39)  || (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" required>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-lg-5">
