...
$pdf->seteventname('Bengaluru Gymnasts Association');
...
$html .='<tr><td >BENGALURU DISTRICT LEVEL GYMNASTICS CHAMPIONSHIP</td></tr>';  
                ...
                <td style="text-align:left;">
                    <table style="width:100%">
                        <tbody>
                            <tr>
                                <td>To</td>
                                <td style="text-align:right;" rowspan="4"><img src="'.$imagepath.'/'.$photo.'" height="100px" /></td>
                            </tr>
                             <tr>
                                <td>Bengaluru Gymnasts Association</td>
                            </tr>
                            <tr>
...
$html .='<tr><td colspan="1">Discipline</td><td colspan="3">'.$artistic.', '.$rhythmic.', '.$aerobic.', '.$acrobatic.'</td></tr>';
...
$html .='<tr><td colspan="4"><strong>Undertaking:</strong> As a bonafide gymnast /sport person / officially actively participating and engaged in the sport of gymnastics under Manager/Coach/President / Gen. Secretary/HOD. I am willing to participate in the District level Championship and selection trails described above. I will be responsible in case physical injury/accident occurred during gymnastics competition.</td></tr>';
$html .='<tr><td colspan="4">&nbsp;</td></tr>';
$html .='<tr><td colspan="4">&nbsp;</td></tr>';
