...
<section>
        <div class="lp spe-bot-red-3">
            ...
            <div class="hom-top-trends row">
             <!--Panel block-->
             <?php 
$sql="SELECT * FROM `panel_apparatus` where eventtype='$eventtype'";
                    ...
                    switch ($eventtype)
					{
					    case 'Artistic':
						    ...
						    {						     		
						     	if($row["apparatus"]=='6')
						     	{
			                        echo '<li><a class="navbar-item textred"  href="vault.php?cat='.$rowinner["category"].'&apid='.$row["apparatus"].'&gender='.$row["gender"].'&panel='.$row["panel"].'&eventid='.$eventid.'">
