...
$html .='<tr><td colspan="2" style="text-align: center;">Entry Form Aerobics Gymnastics</td></tr>'; 
$html .='<tr><td colspan="2">&nbsp;</td></tr>'; 
...
{
    if($row['menindividual'] && $i==1)
    {
        $html .='<tr><td rowspan="2" style="text-align: center;"> MEN INDIVIDUAL</td><td style="width:20px;"> '.$i.'</td><td style="width:150px;"> '. strtoupper($row['name']) . '</td><td style="width:100px;"> '. strtoupper($row['lastname']) . '</td><td> '. $row['aadhaar'] . '</td><td> '.date("d/m/Y", strtotime($row['dob'])). '</td></tr>';
        $i=2;
    }
    else if($row['menindividual'])
    {
...
foreach ($comm->executesql($sql) as $row)
{
    if($row['womenindividual'] && $i==1)
    {
        $html .='<tr><td rowspan="2" style="text-align: center;"> WOMEN INDIVIDUAL</td><td> '.$i.'</td><td style="width:150px;"> '. strtoupper($row['name']) . '</td><td style="width:100px;"> '. strtoupper($row['lastname']) . '</td><td> '. $row['aadhaar'] . '</td><td> '. date("d/m/Y", strtotime($row['dob'])) . '</td></tr>';
        $i=2;
    }
    else if($row['womenindividual'])
    {
        $html .='<tr><td> '.$i.'</td><td style="width:150px;"> '. strtoupper($row['name']) . '</td><td style="width:100px;"> '. strtoupper($row['lastname']) . '</td><td> '. $row['aadhaar'] . '</td><td> '. date("d/m/Y", strtotime($row['dob'])) . '</td></tr>';
    }
}
...
foreach ($comm->executesql($sql) as $row)
{
    if($row['mixedpair'] && $i==1)
    {
        $html .='<tr><td rowspan="4" style="text-align: center;"> MIXED PAIR</td><td> '.$i.'</td><td style="width:150px;"> '. strtoupper($row['name']) . '</td><td style="width:100px;"> '. strtoupper($row['lastname']) . '</td><td> '. $row['aadhaar'] . '</td><td> '. date("d/m/Y", strtotime($row['dob'])) . '</td></tr>';
        $i=2;
    }
    else if($row['mixedpair'])
    {
        $html .='<tr><td> '.$i.'</td><td style="width:150px;"> '. strtoupper($row['name']) . '</td><td style="width:100px;"> '. strtoupper($row['lastname']) . '</td><td> '. $row['aadhaar'] . '</td><td> '. date("d/m/Y", strtotime($row['dob'])) . '</td></tr>';
        $i++;
    }
...
$html .='<tr><td> 2</td><td style="width:150px;"> </td><td style="width:100px;"> </td><td></td><td></td></tr>';
$i=1;
foreach ($comm->executesql($sql) as $row)
{
    if($row['trios'] && $i==1)
    {
        $html .='<tr><td rowspan="6" style="text-align: center;">TRIOS</td><td> '.$i.'</td><td style="width:150px;"> '. strtoupper($row['name']) . '</td><td style="width:100px;"> '. strtoupper($row['lastname']) . '</td><td> '. $row['aadhaar'] . '</td><td> '. date("d/m/Y", strtotime($row['dob'])) . '</td></tr>';
        $i++;
    }
    else if($row['trios'])
    {
...
$html .='<tr><td> 1</td><td style="width:150px;"> </td><td style="width:100px;"> </td><td></td><td></td></tr>';
$html .='<tr><td> 2</td><td style="width:150px;"> </td><td style="width:100px;"> </td><td></td><td></td></tr>';
$html .='<tr><td> 3</td><td style="width:150px;"> </td><td style="width:100px;"> </td><td></td><td></td></tr>';
//Group 5
$html .='<tr><td rowspan="5" style="text-align: center;">GROUP 5 Gymnast</td><td> 1</td><td style="width:150px;"> </td><td style="width:100px;"> </td><td></td><td></td></tr>';
$html .='<tr><td> 2</td><td style="width:150px;"> </td><td style="width:100px;"> </td><td></td><td></td></tr>';
$html .='<tr><td> 3</td><td style="width:150px;"> </td><td style="width:100px;"> </td><td></td><td></td></tr>';
...
$html .='<tr><td style="text-align: center;">COACH</td><td> 1</td><td style="width:150px;"> UJJAL</td><td style="width:100px;"> MONDAL</td><td>441661703252</td><td></td></tr>';
$html .='<tr><td style="text-align: center;">MANAGER</td><td> 1</td><td style="width:150px;"> </td><td style="width:100px;"> </td><td></td><td></td></tr>';
$html .='</table>';
...
$html .='<tr><td colspan="3">Please use same format under 8 to 11 MAG and WAG.</td></tr>';
$html .='<tr><td colspan="3">&nbsp;</td></tr>';
$html .='<tr><td colspan="3">&nbsp;</td></tr>';
